...
public class ImportExcel {
	...
	public void setSheetMergeCount(int sheetMergeCount) {
		this.sheetMergeCount = sheetMergeCount;
	}
	...
	public Object getCellValue(Row row, int column) {
		...
		if (isMergedRegion(row.getRowNum(), column)) {
			return getMergedRegionValue(row.getRowNum(), column);
		}else{
			 Object val = "";
			 try{
	...
	public <E> List<E> getDataList(Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException {
		...
		this.sheetMergeCount = sheet.getNumMergedRegions();
