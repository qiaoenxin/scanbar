...
<body>
	...
	<form:form id="inputForm" modelAttribute="device" action="${ctx}/pro/device/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="serial" htmlEscape="false" maxlength="2048" rows="6" class="required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pro:device:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
